...
namespace RcConnector.Core
{
    ...
    internal static class L
    {
        ...
        private static readonly Dictionary<string, string> EN = new()
        {
            ...
            ["log_rc_forward_started"] = "RC forward → {0}:{1}",
            ["log_rc_forward_create_failed"] = "RC forward: failed to create socket ({0})",
            ["log_rc_forward_send_failed"] = "RC forward: send failed ({0})",
            ["error_rc_forward_socket_title"] = "RC Forward error",
            ["error_rc_forward_socket_msg"] = "Cannot create UDP socket for {0}.\nCheck IPv6 settings on the network interface.\n\n{1}",
            ...
            ["settings_telemetry_mode"] = "Telemetry:",
            ["settings_telemetry_direct"] = "Direct UDP",
            ["settings_telemetry_webrtc"] = "WebRTC",
            ...
            ["settings_signaling_port"] = "WS port:",
            ["settings_signaling_port_hint"] = "\u2139 signaling for browser",
            ["settings_mp_forward_port"] = "GCS port:",
            ["settings_mp_forward_port_hint"] = "\u2139 send telemetry to GCS",
            ["settings_udp_port"] = "UDP listen port:",
            ["settings_udp_port_hint"] = "\u2139 RC input from ESP32 WiFi",
            ...
            ["settings_rc_forward_format"] = "Format:",
        ...
        private static readonly Dictionary<string, string> UK = new()
        {
            ...
            ["log_rc_forward_started"] = "RC forward → {0}:{1}",
            ["log_rc_forward_create_failed"] = "RC forward: не вдалося створити сокет ({0})",
            ["log_rc_forward_send_failed"] = "RC forward: помилка відправки ({0})",
            ["error_rc_forward_socket_title"] = "Помилка RC Forward",
            ["error_rc_forward_socket_msg"] = "Не вдалося створити UDP сокет для {0}.\nПеревірте налаштування IPv6 на мережевому інтерфейсі.\n\n{1}",
            ...
            ["settings_telemetry_mode"] = "Телеметрія:",
            ["settings_telemetry_direct"] = "Прямий UDP",
            ["settings_telemetry_webrtc"] = "WebRTC",
            ...
            ["settings_signaling_port"] = "WS порт:",
            ["settings_signaling_port_hint"] = "\u2139 сигналінг для браузера",
            ["settings_mp_forward_port"] = "GCS порт:",
            ["settings_mp_forward_port_hint"] = "\u2139 телеметрія для GCS",
            ["settings_udp_port"] = "UDP порт прийому:",
            ["settings_udp_port_hint"] = "\u2139 RC вхід від ESP32 WiFi",
            ...
            ["settings_rc_forward_format"] = "Формат:",
